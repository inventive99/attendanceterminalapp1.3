...
import com.inventive.attendanceUser.activity.ViewReportActivity;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  private TextView threadsTextView,lay_view;

  private FloatingActionButton btnSwitchCam,fab_view;
   ...
   // LOGGER.d("onCreate " + this);
    ...
    fab_view.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            pBundle.putString("single", "");
            Intent i=new Intent(CameraActivity.this, MessageActivity.class);
            i.putExtras(pBundle);

            MediaPlayer mediaPlayer = MediaPlayer.create(CameraActivity.this, R.raw.beep06);
            mediaPlayer.start();
    ...
    lay_view.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
